...
use crate::{
    ...
    oidc, Refresh, RefreshStrategy, Validation,
};
...
pub struct AuthorizerBuilder<C>
where
...
pub enum KeySourceType {
    ...
    Secret(String),
    Jwks(String),
    JwksString(String), // TODO: expose JwksString in AuthorizerBuilder or remove it
    Discovery(String),
}
    ...
    pub(crate) async fn build(
        ...
        Ok(match key_source_type {
            ...
            KeySourceType::JwksString(jwks_str) => {
                // TODO: expose it in AuthorizerBuilder or remove
