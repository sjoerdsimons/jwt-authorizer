...
use jwt_authorizer::{
    authorizer::{Authorize, Authorizer, AuthorizerBuilder},
...
async fn successfull_auth() {
    init_test();
    let auth: AuthorizerBuilder<User> = AuthorizerBuilder::from_rsa_pem("../config/rsa-public1.pem");
